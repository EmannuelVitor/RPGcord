      ...
      <aside className="drawer settings-drawer">
        ...
        <section className="settings-content">
          ...
          <div className="credits-list">
            <a href="https://github.com/EmannuelVitor" target="_blank" rel="noreferrer"><Github size={17} /><span><strong>Emannuel Vitor</strong><small>Direção do projeto e desenvolvimento</small></span><ExternalLink size={14} /></a>
